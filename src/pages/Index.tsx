...
const notIncluded = [
  "Перелёт в Афины",
  "Питание и напитки",
  "Аренда квадроциклов и другие активности на берегу",
];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-4 leading-relaxed">
                Padel Banda Yacht Week — это не просто яхтинг. Это комьюнити людей, которые любят
                спорт, море и настоящие эмоции. Мы собрали программу, в которой каждый
                день — новая история.
              </p>
